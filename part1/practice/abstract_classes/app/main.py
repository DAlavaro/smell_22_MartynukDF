...
from part1.practice.abstract_classes.app.boat import Boat
from part1.practice.abstract_classes.app.car import Car
from part1.practice.abstract_classes.app.electroscooter import Electroscooter
